...
def main():
    ...
    for epoch in range(start_epoch,  epoch_num):
        ...
        with torch.no_grad():
            ...
            plt.savefig('./GAN_new_log/dcgan_epoch_%d.png' % epoch)
            plt.close()
        # save models
        torch.save(netG.state_dict(), './stellarGAN_G/stellarGAN_%d.pkl' % epoch)
        torch.save(netD.state_dict(), './stellarGAN_D/stellarGAN_%d.pkl' % epoch) 
